class Info_nutri
    ...
    attr_accessor :nombre,:calorias, :grasas, :grasa_saturada, :hidratos_carbono, :azucares, :proteina, :sal, :porciones, :gramos
    
    def initialize(nombre,calorias,grasas,grasa_saturada,hidratos_carbono,azucares,proteina,sal,porciones,gramos)
       self.nombre = nombre
